...
# ims, peak_freqs, peak_magnitudes = plotstft('IMP23ABSU_MIC_1k_Test_Tone.wav')
ims, peak_freqs, peak_magnitudes = plotstft(r'..\Well_Data_Collected_8_31_2023\Good_Wells_8_31_2023\well_1\below_motor_mount_Exported\IMP23ABSU_MIC.wav')
